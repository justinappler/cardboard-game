...
/**
 * <p>The KeyBindings class models all key binding for
 * the game. If a player changes any key bindings, the class 
 * persist it to retain the information for future games.</p>
 * 
 * <b>Operations:</b>
 * <ul>
 ...
 * </ul>
 * 
 * File Format for persistence: The file format is the KEY_BIND followed
 * by the key text that represents it. They are separated by a space
 * and each different binding is on its own row.
 * -----------------------------
 * HINT h
 * PAUSE p
 * -----------------------------
 ...
 *  
 * @history
 *  - 12/03/08 Version 1.1 Added Version History. Moved all KeyBinding methods 
 *  and enums to KeyBindings class. Added TODO
 *  - 12/05/08 Version 1.2 Finished peusdocode and TODO
 */
public class KeyBindings {
	...
	public enum KEY_BIND {
		...
		/** The keyboard key that removes the card at inlay position 1 
		 * assuming that there is a card there */
		REMOVE_INLAY_POS_ONE,
		
		/** The keyboard key that removes the card at inlay position 2 
		 * assuming that there is a card there */
	 ...
	 * 
	 * @param keyBinding The keyboard binding for a specific action. 
	 ...
	 * 
	 * @param keyMap The HashMap of all the keyboard binding and there keys.
	 */
