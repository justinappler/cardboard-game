 ...
 * <b>Operations:</b>
 * <ul>
 * <li>The HighScoresWindow class can create a high scores window to display the top ten scores.
 * </ul>
 * 
 * @author Brad Barrows
 * @version 1.3
...
public class HighScoresWindow
{
    ...
    * @param  highscores   The instance of Highscores to get the top ten scores from. 
    * @see    HighScores
    */
   public HighScoresWindow(HighScores highscores) 
   {
	   ...
	   //   APPEND the place and the current highscore name and score to theScores
	   //   INCREMENT place
	   //END WHILE
	   
	   //CREATE a dialog containing the string created above and a button labeled "Ok" to close the dialog
   }
