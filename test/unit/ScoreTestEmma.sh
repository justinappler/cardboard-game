...
javac -classpath ./Score/classes:./junit.jar -d Score/classes Score/com/immortallabs/cardboard/game/ScoreTest.java
...
java -cp ../resources/emma.jar emma instr -ip ./Score/classes/ -m overwrite -filter +*Score -filter -Score* -out Score_Unit.em
