...
public class CardBoardResource
{
    ...
    private static BufferedImage addImageToMap(Object caller, String imageName)
    {
        ...
        try
        {
            returnVal = ImageIO.read(caller.getClass().getResourceAsStream("/images/" + imageName));
        }
        catch (Exception e1)
        {
    ...
    private static Clip addSoundToMap(Object caller, String soundName)
    {
        ...
        try
        {
            inputStream = AudioSystem.getAudioInputStream((caller.getClass()
       ...
       info = new DataLine.Info(Clip.class, inputStream.getFormat());
        ...
        //TRY and convert a DataLine, which implements Clip, into a sound Clip and open it
        try
        {
