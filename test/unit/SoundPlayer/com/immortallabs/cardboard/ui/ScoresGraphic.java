...
public class ScoresGraphic extends JComponent
{
    ...
    * 
    * @param com.immortallabs.cardboard.game.GameState.Player player
    *    the player that has buzzed in
    */
   ...
   public void paint(Graphics g)
   {
      ...
      g.setFont(java.awt.Font.decode("Arial-BOLD-16"));
      ...
      else if (amountOfPlayers == kTwoPlayers)
      {
         ...
         if (buzzedPlayer == PLAYER.PLAYER1)
         {
            ...
            g.drawString("Player 2: " + player2.getScore(), drawLocation.x
                  + width, drawLocation.y);
         }
      ...
      else if (amountOfPlayers == kThreePlayers)
      {
         ...
         else if (buzzedPlayer == PLAYER.PLAYER2)
         {
            ...
            g.drawString("Player 3: " + player3.getScore(), drawLocation.x
                  + width, drawLocation.y);
         }
         ...
         else
         {
            ...
            g.drawString(
                  "Player 1: " + player1.getScore() + "     Player 2: "
                        + player2.getScore() + "     Player 3: "
      ...
      else if (amountOfPlayers == kFourPlayers)
      {
         ...
         else if (buzzedPlayer == PLAYER.PLAYER3)
         {
            ...
            g.drawString("Player 4: " + player4.getScore(), drawLocation.x
                  + width, drawLocation.y);
         }
         ...
         else if (buzzedPlayer == PLAYER.PLAYER4)
         {
            ...
            g.drawString("Player 1: " + player1.getScore() + "     "
                  ...
                  + player3.getScore() + "     ", drawLocation.x,
                  drawLocation.y);
