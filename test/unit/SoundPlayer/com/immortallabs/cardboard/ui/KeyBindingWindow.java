...
/**
 * <p>
 * The KeyBindingsWindow class models a window for a user to change all key
 ...
 * @history - 12/04/08 1.1 Create constructor with pseudocode. Added TODO -
...
{
    /**
     * The current KeyBindings. This is used to get the current key bindings as
     * well as save them since KeyBindings does the persistence.
     */
    ...
    /**
     * <p>
     * This private class implements a KeyListener for TextFields
     * </p>
     * 
     * @author Thomas Dvornik
     * @author RustyNail CSC308 F08
    ...
    private class textFieldListener implements KeyListener
    {
         ...
         * 
         * @param textField
         *            The testField that this listener was added too
         */
    ...
    /**
     * Finds the KEY_BIND with a given key values as a string. This method is
     * used to get a KEYBIND with a string from the keyMap
     * 
     * @param keyValue
     *            String to turn into a KEY_BIND
    ...
    /**
     * Handles the Save and Cancel button. If Save is pushed, save the key
     * binding to KeyBinding. Else if cancel is pushed, close the window and
     * don't do anything.
     * 
     * @param actionEvent
