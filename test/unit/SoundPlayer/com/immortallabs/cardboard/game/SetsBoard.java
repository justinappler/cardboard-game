...
public class SetsBoard
{
    ...
    /**
     * Holds all the Cards from the previous set
     */
    private ArrayList<Card> lastSet;
    ...
    public void clearSetFromInlay()
    {
        ...
        // COPY each card from the inlayList to the lastSet
        lastSet.set(0, inlayList.get(0));
        lastSet.set(1, inlayList.get(1));
        lastSet.set(2, inlayList.get(2));
    ...
    public void returnInlayToBoard()
    {
        ...
        while (inlayIndex >= 0)
        {
        	// SET theCard to a copy of the card at the current location in inlayList
        	Card theCard = (Card)inlayList.get(inlayIndex).clone();
            ...
            // SET lastSet at index inlayIndex with a copy of the card
            lastSet.set(inlayIndex, theCard);
    ...
    /**
     * Returns the last set that was in the in-lay
     * 
     * @return the last set cards that were the from the in-lay
     */
    public ArrayList<Card> getLastSet()
    {
    	// RETURN the last set
    	return lastSet;
    }
    ...
    /**
     * Removes all of the cards that were in the last set from the in-lay
     */
    public void clearLastSet() 
    {
    	// SET indexes 0,1,2 to null
    	lastSet.set(0, null);
    	lastSet.set(1, null);
    	lastSet.set(2, null);
    }
