...
public class KeyBindings
{
    ...
    /**
     * Key for asking for three more cards
     */    
    private static final String kKeyThreeMore = "84";
    
    /**
     * Key for moving a card from the table to the inlay
     */    
    private static final String kKeySelect = "10";
    
    /**
     * Key for moving the selected card up
     */    
    private static final String kKeyUp = "38";
    
    /**
     * Key for moving the selected card down
     */    
    private static final String kKeyDown = "39";
    
    /**
     * Key for moving the selected card left
     */    
    private static final String kKeyLeft = "40";
    
    /**
     * Key for moving the selected card right
     */    
    private static final String kKeyRight = "37";
    
    /**
     * Key for moving the first card in the inlay back to the table
     */    
    private static final String kKeyRemoveInlayOne = "49";
    
    /**
     * Key for moving the second card in the inlay back to the table
     */    
    private static final String kKeyRemoveInlayTwo = "50";
    
    /**
     * Key for player one to buzz in
     */    
    private static final String kKeyBuzzOne = "16";
    
    /**
     * Key for player two to buzz in
     */    
    private static final String kKeyBuzzTwo = "32";
    
    /**
     * Key for player three to buzz in
     */    
    private static final String kKeyBuzzThree = "10";
    
    /**
     * Key for player four to buzz in
     */    
    private static final String kKeyBuzzFour = "96";
