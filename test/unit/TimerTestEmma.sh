...
java -cp ../resources/emma.jar emma instr -ip ./Timer/bin/ -m overwrite -out Timer_Unit.em -ix +com.immortallabs.cardboard.game.Timer*
...
java -classpath :../resources/emma.jar:Timer/bin/:../../lib/junit4.jar org.junit.runner.JUnitCore unit.Timer.TimerTest
