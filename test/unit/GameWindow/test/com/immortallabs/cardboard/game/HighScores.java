...
/**
 * <p>
 * The HighScores class models a high score list. The High Score class can have
 * up to 10 High Scores each of which has a score value and a name associated
 * with it. When a High Score is added to a full list, the lowest score is
 ...
 * @see Logic
 * 
 * @history - 01/13/08 Updated the author tags and version. - 12/04/08 1.2
 *          Conformed JavaDocs to RustyNail Standard, Added Package<br> -
 *          12/02/08 1.1 Added Version History & Pseudoscode<br> - 12/01/08 1.0
 *          Initial Class Skeleton<br>
 */
public class HighScores
{
   /**
    * The location of the High Scores data file relative to the current
    * directory
    */
   ...
   /**
    * Checks to see if the passed score is higher than the lowest score in the
    * list of High Scores.
    * 
    * @param score
    *           Score to compare to the list
    ...
    * 
    * Pre-condition: The passed score is higher than the last score in the list
    * 
    * @param score
    *           The score to add
    * @param name
    *           The player name/handle to associate with the score
    */
   ...
   /**
    * Gets the name of the player with the given index in the list of High
    * Scores.
    * 
    * (1 returns the player in First Place, 10 returns the player in last place)
    * 
    * @param index
    *           The rank of the player in the High Score List
    * @return The name/handle of the player at the given index
    * @throws IndexOutOfBoundsException
    *            If the index is less than 1 or greater than 10
    */
   public String getHighScoreName(Natural index)
         throws IndexOutOfBoundsException
   {
   ...
   /**
    * Gets the score of the player with the given index in the list of High
    * Scores
    * 
    * (1 returns the player in First Place, 10 returns the player in last place)
    * 
