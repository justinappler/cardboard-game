 ...
 * @version 12/05/08
 * @history 
 *          - 02/20/09 1.2 Changed to a singleton class.
 *          - 12/02/08 1.1 Added Version History & Pseudocode to
...
public class CardBoardPreferences
{
    ...
    /**
     * @param pref the desired enumeration
    ...
    /**
     * @param pref  The enumeration to modify
     * @param value The new value of the enumeration pref
     */
