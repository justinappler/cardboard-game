...
public class SetsBoard
{
    ...
    public void addThreeMore()
    {
        ...
        if (getInlaySize().intValue() == kInlaySize)
        {
            ...
            {              
                int origSize = (numRows.ordinal() + 3) * 3;
                int index = origSize;
                boolean breakOut = false;
                
                for (int iterator = 0; iterator < (numRows.ordinal() + 3) * 3; iterator++) 
                {
     ...
     * 
     * @param set true  if set is valid
     *            false if set is invalid
    ...
    private String getReasons(boolean set)
    {
        ...
        // IF the set in the in-lay is valid
        if(set)
        {
            // IF all the colors are the same
            if(c1.getColor() == c2.getColor() && c1.getColor() == c3.getColor())
            {
                // SET retString to say that all the cards have same color
                retString = retString + "-All cards are " + c1.getColor() + "\n";
            }
            // ELSE all cards have different colors
            else
            {
                // SET retString to say all cards have different colors
                retString = retString + "-All cards have different colors\n";
            }
            // END IF
            
            // IF all cards have same fill
            ...
            // ELSE all cards have different fill
            else
            {
                // SET retString to corresponding message
            ...
            // ELSE all cards have different numbers
            else
            {
                // SET retString to corresponding message
        ...
        // ELSE the set in the in-lay is invalid
        else
        {            
            ...
            if(!isFeatureSet(c1.getColor(), c2.getColor(), c3.getColor()))
            {
                ...
                {
                    // SET retString to corresponding message
                    retString = retString + "COLOR: Bottom card does not match the top and middle\n";
                }
                // ELSE IF first and last cards are matching
                else if(c1.getColor() == c3.getColor())
                {
                    // SET retString to corresponding message
                    retString = retString + "COLOR: Middle card does not match the top and bottom\n";
                }
                // ELSE IF second and third cards are matching
                else if(c2.getColor() == c3.getColor())
                {
                    // SET retString to corresponding message
                    retString = retString + "COLOR: Top card does not match the middle and bottom\n";
                }
                // END IF
            }
            if(!isFeatureSet(c1.getFill(), c2.getFill(), c3.getFill()))
            {
                ...
                {
                    // SET retString to corresponding message
                    retString = retString + "FILL: Bottom card does not match the top and middle\n";
                }
                // ELSE IF first and last cards are matching
                else if(c1.getFill() == c3.getFill())
                {
                    // SET retString to corresponding message
                    retString = retString + "FILL: Middle card does not match the top and bottom\n";
                }
                // ELSE IF second and third cards are matching
                else if(c2.getFill() == c3.getFill())
                {
                    // SET retString to corresponding message
                    retString = retString + "FILL: Top card does not match the middle and bottom\n";
                }
                // END IF
            }
            if(!isFeatureSet(c1.getNumber(), c2.getNumber(), c3.getNumber()))
            {
                ...
                {
                    // SET retString to corresponding message
                    retString = retString + "NUMBER: Bottom card does not match the top and middle\n";
                }
                // ELSE IF first and last cards are matching
                else if(c1.getNumber() == c3.getNumber())
                {
                    // SET retString to corresponding message
                    retString = retString + "NUMBER: Middle card does not match the top and bottom\n";
                }
                // ELSE IF second and third cards are matching
                else if(c2.getNumber() == c3.getNumber())
                {
                    // SET retString to corresponding message
                    retString = retString + "NUMBER: Top card does not match the middle and bottom\n";
                }
                // END IF
            }
            if(!isFeatureSet(c1.getShape(), c2.getShape(), c3.getShape()))
            {
                ...
                {
                    // SET retString to corresponding message
                    retString = retString + "SHAPE: Bottom card does not match the top and middle\n";
                }
                // ELSE IF first and last cards are matching
                else if(c1.getShape() == c3.getShape())
                {
                    // SET retString to corresponding message
                    retString = retString + "SHAPE: Middle card does not match the top and bottom\n";
                }
                // ELSE IF second and third cards are matching
                else if(c2.getShape() == c3.getShape())
                {
                    // SET retString to corresponding message
                    retString = retString + "SHAPE: Top card does not match the middle and bottom\n";
                }
                // END IF
            }
            // END IF
    ...
    public String explanation()
    {
        ...
        if(!isInlaySet())
        {
            ...
            {
                // SET returnString to say is is not a set because there is not 3 cards selected
        ...
        // ELSE the cards in the in-lay make a valid set
        else 
        {
            // SET explanation to say this is a set because: ...
            explanation = explanation + "This is a set because:\n";
            
            // APPEND the resultString to explanation
            returnString = explanation + getReasons(true);
        }
        // END IF
    ...
    public boolean moveCardToInlay(Card theCard, Boolean isHint)
    {
        ...
        else
        {
            ...
            if (boardContainsSet())
            {
                // SET index to hintList at hintIndex position and increment hintIndex
    ...
    public boolean isInlaySet()
    {
        ...
        if (getInlaySize().intValue() == kInlaySize)
        {
            ...
            // in inlay
            retValue =
                    checkForSet(inlayList.get(0), inlayList.get(1), inlayList.get(2));
        }
        // END IF
