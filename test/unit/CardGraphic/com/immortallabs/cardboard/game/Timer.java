 ...
 * <li>Timer class can count the number of seconds that have passed.</li>
...
public class Timer extends Observable
{
    ...
    public enum TIMER_LIMIT
    {
        ...
        TIME_UNLIMITED(kCountdownDisabled);
    ...
    public void buzzIn()
    {
        ...
        targetSeconds = TIMER_LIMIT.TIME_15SEC.getTimeInSeconds();
