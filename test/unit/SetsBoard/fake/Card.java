...
public class Card
{
    ...
    */
   public Card(SHAPE s, COLOR c, FILL f, NUMBER n)
   {
   ...
   {
	   System.err.println("=============================");
	   System.err.println("shape : " + this.shape);
	   System.err.println("number: " + this.number);
	   System.err.println("fill  : " + this.fill);
	   System.err.println("color : " + this.color);
   }
   ...
   public boolean equals(Object obj)
   {
	   ...
	   if( obj instanceof Card)
		...
		if(this.getColor() == c2.getColor())
		{
			if(this.getFill() == c2.getFill())
				if(this.getShape() == c2.getShape())
					if(this.getNumber() == c2.getNumber())
						retVal = true;
		}	
		return retVal;
   } 
