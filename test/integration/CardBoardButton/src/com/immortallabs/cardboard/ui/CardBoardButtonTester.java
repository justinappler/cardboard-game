...
public class CardBoardButtonTester
{
   ...
   {     
      b1 = new CardBoardButton(new Point(0, 0), null, BUTTONTYPE.EXPLAIN, "Explain");
      b2 = new CardBoardButton(new Point(0, 100), null, BUTTONTYPE.WELCOME, "Welcome");
      b3 = new CardBoardButton(new Point(0, 200), null, BUTTONTYPE.HINT, "Hint");
      b4 = new CardBoardButton(new Point(0, 300), null, BUTTONTYPE.PAUSE, "Pause");
      b5 = new CardBoardButton(new Point(0, 400), null, BUTTONTYPE.UNPAUSE, "Unpause");
      b6 = new CardBoardButton(new Point(0, 200), null, BUTTONTYPE.THREEMORE, "Three More");
