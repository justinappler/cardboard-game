...
public class ScoresGraphicTester
{
   ...
   private void buzzPlayers() throws InterruptedException
   {
      if (number == 2)
      {
         players.setBuzzedPlayer(PLAYER.PLAYER1);
         players.paint(main.getGraphics());
      
         Thread.sleep(1000);
         
         players.setBuzzedPlayer(PLAYER.PLAYER2);
         players.paint(main.getGraphics());
      ...
      if (number == 3)
      {
         ...
         players.setBuzzedPlayer(PLAYER.PLAYER3);
         players.paint(main.getGraphics());
      ...
      if (number == 4)
      {
         ...
         players.setBuzzedPlayer(PLAYER.PLAYER4);
         players.paint(main.getGraphics());
