...
java -cp ../resources/emma.jar emma instr -ip CardBoardPreference/bin/ -m overwrite -out CardBoardPreferences_Int.em -ix +com.immortallabs.cardboard.CardBoardPreferences*
...
java -classpath :../resources/emma.jar:CardBoardPreference/bin/:../../lib/junit4.jar org.junit.runner.JUnitCore integration.CardBoardPreference.PrefUnitTest
