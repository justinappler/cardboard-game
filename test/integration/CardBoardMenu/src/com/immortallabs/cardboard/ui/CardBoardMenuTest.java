...
import com.immortallabs.cardboard.game.*;
import com.immortallabs.cardboard.ui.*;
...
public class CardBoardMenuTest extends TestCase
{
	...
	public void setUp()
	{
		test = new CardBoardMenu(new ActionMap(new GameState(false), new GameWindow(new javax.swing.JFrame(), true)));
		test2 = new CardBoardMenu(new ActionMap(new GameState(false), new GameWindow(new javax.swing.JFrame(), true)));
	}
