...
{ 
         ...
         { 
             ...
             { 
                 ...
                 System.out.print("Enter the time limit you desire" 
                      + " [15 seconds(f), 30 seconds(t), 45 second(o)," 
                           + " or unlimited(u)]"); 
                 ...
                 if(readIn == 'f') 
                 { 
                     pref.setPreference(CardBoardPreferences.PREF.
                         TIME_LIMIT, "TIME_15SEC"); 
                 } 
                 //If the user chose a thirty second game 
                 else if(readIn == 't') 
                 { 
                     pref.setPreference(CardBoardPreferences.PREF.
                         TIME_LIMIT, "TIME_30SEC"); 
                 } 
                 //If the user chose a forty-five second game 
                 else if(readIn == 'o') 
                 { 
                     pref.setPreference(CardBoardPreferences.PREF.
                         TIME_LIMIT, "TIME_45SEC"); 
                 } 
                 //If the user chose a unlimited time game 
                 else if(readIn == 'u') 
                 { 
                     pref.setPreference(CardBoardPreferences.PREF.
                         TIME_LIMIT, "TIME_UNLIMITED"); 
                 } 
             ...
             { 
                 ...
                 if(readIn == '2') 
                 { 
                     pref.setPreference(CardBoardPreferences.PREF.PLAYERS, "TWO"); 
                 } 
                 //If the user chose a 3 player game 
                 else if(readIn == '3') 
                 { 
                     pref.setPreference(CardBoardPreferences.PREF.PLAYERS, "THREE"); 
                 } 
                 //If the user chose a 4 player game 
                 else if(readIn == '4') 
                 { 
                     pref.setPreference(CardBoardPreferences.PREF.PLAYERS, "FOUR"); 
                 } 
        ...
        { 
            ...
            { 
                ...
                { 
                    Card currentPos = board.getCardFromBoard(new 
                        Natural(rowNum), new Natural(colNum)); 
        ...
        **/ 
        ...
        { 
            ...
            // Hidden entry because the textUI is not connected to high scores
            if(userChoice == '-') 
            { 
     ...
     * @param player The player who is currently buzzed in, null if there is
     * no buzzed in player
     */ 
