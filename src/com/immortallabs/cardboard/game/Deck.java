...
{ 
       ...
       private Natural cardsInDeck; 
         ...
         * deck it has 27 cards, 3 different Numbers, Shapes, and Fills but only one 
         * Color 
         ...
         /* For every card's number */ 
            ...
            { 
                ...
                { 
                    ...
                    { 
                     //Add created cards to the ArrayList 
                     placeInOrder.addAll(addNumCol(num, col)); 
                    } 
                } 
            ...
            //For the size of the deck minus 1 to account for index errors, 
            //switch the order of cards in the deck. Required because of the 
            //order of the enums in the Card class. 
            for(index = cardsInDeck.intValue()-1; index >= 0; index--) 
            { 
        ...
        /** 
         * A private method used by createDeck to remove duplicate code used in  
         * the creation of both normal decks and beginner decks. Automatically 
         * adds the correct shapes and fills to the deck. 
         * @param num The number of shapes to be added in the Cards. 
         * @param col The color of the shapes to be added in the Cards. 
         * @return A set of the cards used in the Deck. 
         */ 
        private ArrayList<Card> addNumCol(Card.NUMBER num, Card.COLOR col) 
        { 
         ArrayList<Card> createSetOfCards = new ArrayList<Card>(); 
         /* For every card's shape */ 
            ...
            { 
                ...
                { 
                  //Create a new Card with the prescribed characteristics 
                    Card tempCard = new Card(sha, col, fil, num); 
                    //Add the created card to the ArrayList 
                    createSetOfCards.add(tempCard); 
                }    
            } 
            return createSetOfCards; 
        } 
